...
public class GUI_Gaji extends javax.swing.JFrame {
    ...
    if (Pegawai instanceof Karyawan) {
        ...
        txtTotal.setText(Integer.toString(karyawan.hitungGaji()));
        ...
        txtTotal.setText(Integer.toString(Pegawai.hitungGaji()+ (Pegawai.getJmlHadir()*Pegawai.T_trans)));
        ...
        txtTotal.setText(Integer.toString(manager.hitungGaji() + (Pegawai.getJmlHadir()*Pegawai.T_trans) + (Pegawai.getJmlLembur()*Pegawai.Lembur)));
    }
