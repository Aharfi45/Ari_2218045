...
public class GUI_GAJI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gaji Perusahaan");
    ...
    private void btnTotalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTotalActionPerformed
        ...
        if(jComboBox1.getSelectedIndex()==0){
           txtTotal.setText(Integer.toString(gj.GajiKar()));
        }else if(jComboBox1.getSelectedIndex()==1){
           txtTotal.setText(Integer.toString(gj.GajiSekretaris(hadir)));
        }else if(jComboBox1.getSelectedIndex()==2){
           txtTotal.setText(Integer.toString(gj.GajiManager(hadir, lmbr)));
        }
